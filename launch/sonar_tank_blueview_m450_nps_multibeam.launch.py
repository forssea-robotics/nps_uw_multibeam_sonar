...
def generate_launch_description():
    ...
    world_file = os.path.join(get_package_share_directory(
        'nps_uw_multibeam_sonar'), 'worlds', 'sonar_tank_blueview_m450_nps_multibeam.world')
    ...
    image_view_sonar_node = Node(
        ...
        parameters=[{"window_name": "blueview_m450", "autosize": True, "filename_format": "/tmp/SonarImage_capture_%04i.jpg"}],
